    ...
    <main>
      <section class="mbtiInfo">
        ...
        <p class="mbtiInfo_text">
          ...
          호기심이 많다 이론이나 책보단 경험과 실생활을 통해 배우는 것을 선호한다. 성격이 급하고
          활발하며 이야기하는 것을 좋아한다. 계획을 잘 세우지만 그 계획에 따라 실천하는 것을
          싫어한다. 주변에서 관종이라는 말을 자주 듣는다. 충동적이고 열정적이지만 싫증이 빠르게 나고
          진지하지 못한 면이 있다.
        </p>
      </section>
      <section class="mbtiInfo2">
        ...
        <p class="mbtiInfo2_text">
          ...
          보여준다. 게임이 진행되는 와중에 꾸준히 시끄럽고 언행이 거칠고 활발하며 이야기를 많이
          한다. 두뇌회전이 빠르고 상황판단이 뛰어나서 게임 속 난관들을 해결해 나간다. 마지막 다리
          건너기 게임에서 장덕수를 잡고 자살하는 모습에서 한미녀의 충동적인 모습을 볼 수 있다.
        </p>
      </section>
